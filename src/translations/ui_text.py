...
INDEX = {
    ...
    "major1": {"ja": "第1メジャー", "en": "First Major"},
    "major2": {"ja": "第2メジャー", "en": "Second Major"},
    "select_semester": {"ja": "セメスタを選択してください", "en": "Please select a semester"},
    "select_major1": {"ja": "第1メジャーを選択してください", "en": "Please select your first major"},
    "select_major2": {"ja": "第2メジャーを選択してください", "en": "Please select your second major"},
    "major1_help": {"ja": "第1メジャーを選択してください", "en": "Select your first major"},
    "major2_help": {"ja": "第2メジャーを選択してください（第1メジャーと異なるもの）", "en": "Select your second major (different from first major)"},
    ...
    "error_major_required": {"ja": "第1メジャーと第2メジャーは必須です。", "en": "First and second majors are required."},
    "error_major_same": {"ja": "第1メジャーと第2メジャーに同じメジャーは選択できません。", "en": "First and second majors must be different."},
    ...
    "help_majours_name": {"ja": "ISは「情報システムデザイン」、NCは「ネットワークコンピューティング」、XDは「クロスリアリティ・情報デザイン」の略称です", "en": "IS stands for \"Information Systems Design,\" NC for \"Network Computing,\" and XD for \"Cross Reality and Information Design.\""},
...
RESULT = {
    ...
    "shared_courses": {"ja": "第1メジャー第2メジャー共有科目(情報学領域共有科目を含む)", "en": "First & Second Major Shared Courses (including Information Science Shared Courses)"},
    ...
    "required_elective_category": {"ja": "選択必修", "en": "Required Elective"},
    "elective_category": {"ja": "選択", "en": "Elective"},
    "credits_unit": {"ja": "単位数", "en": "Credits"},
    "total_simple": {"ja": "合計", "en": "Total"},
    "label_major1": {"ja": "1", "en": "1st"},
    "label_shared": {"ja": "共", "en": "Shared"},
    "label_major2": {"ja": "2", "en": "2nd"},
    ...
    "course_category": {"ja": "履修区分", "en": "Course Category"},
    "course_category_required": {"ja": "必修", "en": "Required"},
    "course_category_required_elective": {"ja": "選択必修", "en": "Required Elective"},
    "course_category_elective": {"ja": "選択", "en": "Elective"},
    "course_category_mandatory": {"ja": "必履修", "en": "Mandatory"},
